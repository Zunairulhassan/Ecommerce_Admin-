...
const CategoryList = () => {
  ...
  const columns = [
    { id: 'image', label: 'CREATE IMAGE', minWidth: 150 },
    { id: 'catName', label: 'CREATE NAME', minWidth: 150 },
    ...
    <>
      <div className="flex flex-col p-5 card bg-white shadow-md pb-4">
        <div className="flex items-center justify-between">
          <h1 className="font-[700] text-[20px]">Category List</h1>
          ...
          <div className="button ml-auto flex items-center justify-between gap-4">
            ...
            <Button className="btn-blue" onClick={() => context.setIsOpenFullScreen({
              ...
              <IoMdAdd className="text-white text-[20px]" /> Add New Category
            </Button>
          </div>
